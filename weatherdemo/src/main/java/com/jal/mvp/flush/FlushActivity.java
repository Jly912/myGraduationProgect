...
public class FlushActivity extends BaseActivity {
    ...
    protected void init() {
        ...
        ScaleAnimation animation=new ScaleAnimation(1.0f,1.f,1.0f,1.2f);
        animation.setDuration(2000);
        animation.setFillAfter(true);
        iv = (ImageView) findViewById(R.id.iv_flush);
        getPermission();
    ...
    public class MyLocationListener implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if(province!=null||district!=null||city!=null||street!=null||streetNumber!=null){
                ...
                EventBus.getDefault().postSticky(new LocationEvent("定位成功"));
            }
