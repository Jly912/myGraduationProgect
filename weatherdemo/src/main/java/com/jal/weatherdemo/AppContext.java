...
public class AppContext extends Application{
    ...
    public void onCreate() {
        ...
        Log.e("print","--------utility----"+utility);
        Cache cache=new Cache(new File(context.getCacheDir().getAbsolutePath(),"HttpCache"),1024*1024*10);
    ...
    public static OkHttpUtils getOKHttpUtil(){
        return okHttpUtils;
    }
